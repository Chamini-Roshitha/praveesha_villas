...
<div class="d-flex justify-content-around align-items-center text-center p-3 row"  style=" top:10vh; background-color:var(--Quaternary); z-index:95; width:100vw; ">
    <div class="col-5"  style="background-color:var(--Quaternary);">
...
<div style="top:18vh; min-height:100vh;">
    <div class="row my-5 px-5 d-flex justify-content-around" style="width:100vw;"><div name="1" id="1" class="col-3 m-0 p-0 room" style="background-color:var(--background);border: 0.5vh solid var(--background);border-radius: 2vh;">
        ...
        <div class="row">
            <img class="m-0 p-0" src="<?= WEB_URL ?>assets/images/v2.jpg" alt="" style="height: 25vh; object-fit: cover; border-radius: 2vh 2vh 0 0;">
        </div>
        <div class="p-2">
        ...
        <div class="row">
            <img class="m-0 p-0" src="<?= WEB_URL ?>assets/images/v4.jpg" alt="" style="height: 25vh; object-fit: cover; border-radius: 2vh 2vh 0 0;">
        </div>
        <div class="p-2">
