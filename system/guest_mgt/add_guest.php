...
<?php
  if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (empty($error)) {
      ...
      (first_name, last_name, guest_nic, guest_email, guest_password, address, city, province, telephone, gender, profile_image) 
      VALUES (
      '$fname',
      '$lname',
      '$id',
          ...
          <form method="post" enctype="multipart/form-data" novalidate>
            ...
            <div class="row my-2">
              ...
              <div class="col-6">
                ...
                <input type="text" name="telephone" placeholder="telephone" class="mt-2">
              </div>
            </div>
